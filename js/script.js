...
funCubicUp.addEventListener('click', () => {
    ...
    fun3dCubic1part.style.transform = ` translateZ(300px) translateY(150px) rotateX(${90 * (2-i)}deg)` // perspective(2000px) works, but not the way I want, need to understand why
    fun3dCubic2part.style.transform = `translateZ(-150px) rotateX(${90 * (2-i)}deg)` // perspective(2000px) works, but not the way I want, need to understand why
});
