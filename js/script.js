...
funCubicUp.addEventListener('click', () => {
    ...
    fun3dCubic1part.style.transform = `perspective(2000px) rotateX(${90 * (2-i)}deg) translateZ(150px)` // perspective(2000px) works, but not the way I want, need to understand why
